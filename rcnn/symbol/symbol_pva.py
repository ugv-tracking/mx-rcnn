...
def get_pva_train(num_classes=config.NUM_CLASSES, num_anchors=config.NUM_ANCHORS):
    ...
    pool5 = mx.symbol.ROIPooling(
        name='roi_pool5', data=conv_feat, rois=rois, pooled_size=(14, 14), spatial_scale=1.0 / config.RCNN_FEAT_SRTIDE)

    # conv5
    conv5_1 = InceptionFactoryB(pool5, 64, 96, 192, 32, 64, 128, 384, 'conv5_1')
    ...
    # avg
    avg = mx.symbol.Pooling(data=conv5_4, global_pool=True, kernel=(7, 7), stride=(1, 1), name="global_pool", pool_type='avg')
